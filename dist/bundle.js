(function (exports, pako) {
    ...
    const getEncoder = () => {
        return window.TextEncoder
            ...
            : {
                encode: function (e) {
                    for (var t = new ArrayBuffer(e.length), n = new Uint8Array(t), i = 0, o = e.length; i < o; i++)
                        n[i] = e.charCodeAt(i);
                    return t;
                },
            };
    ...
    const mergeArrayBuffer = (e, t) => {
        var n = new Uint8Array(e), i = new Uint8Array(t), o = new Uint8Array(n.byteLength + i.byteLength);
        return o.set(n, 0), o.set(i, n.byteLength), o.buffer;
    };
    const callFunction = (e, t) => {
    ...
    class DanmakuWebSocket {
        ...
        constructor(options) {
            ...
            if (0 !== this.options.urlList.length &&
            ...
            this.mixinCallback().initialize(this.options.urlList.length > 0
        ...
        initialize(e) {
            let t = this, n = "MozWebSocket" in window ? window.MozWebSocket : window.WebSocket, i = this.options;
            try {
                this.ws = new n(e);
                ...
                var o = this.state.connectTimeoutTimes >= 3
        ...
        mixinCallback() {
            let e = this.options, t = this.callbackQueueList;
        ...
        // websocket
        onOpen() {
            return (callFunction(this.callbackQueueList.onOpenQueue),
        ...
        userAuthentication() {
            var e = this, t = this.options, n = {
                ...
                protover: parseInt("" + t.protover, 10) ||
            ...
            for (var r = 0; r < t.customAuthParam.length; r++) {
                var a = t.customAuthParam[r], s = a.type || "string";
                switch ((void 0 !== n[a.key] &&
                    console.error("Token has the same key already! 【" + a.key + "】"),
                    (a.key.toString() && a.value.toString()) ||
                        console.error("Invalid customAuthParam, missing key or value! 【" +
                            a.key +
                            "】-【" +
                            a.value +
                            "】"),
            ...
            (i = this.convertToArrayBuffer(JSON.stringify(n), CONSTANTS.WS_OP_USER_AUTHENTICATION)),
        ...
        convertToArrayBuffer(e, t) {
            ...
            var n = new ArrayBuffer(CONSTANTS.WS_PACKAGE_HEADER_TOTAL_LENGTH), i = new DataView(n, CONSTANTS.WS_PACKAGE_OFFSET), r = this.encoder.encode(e);
            return (i.setInt32(CONSTANTS.WS_PACKAGE_OFFSET, CONSTANTS.WS_PACKAGE_HEADER_TOTAL_LENGTH + r.byteLength),
        ...
        onClose() {
            ...
            return (callFunction(this.callbackQueueList.onCloseQueue),
                clearTimeout(this.HEART_BEAT_INTERVAL),
                this.options.retry
                                    ...
                                    : 0 !== t && e.state.index > t - 1
                                        ? ((e.state.index = 0),
                                            ...
                                            1 === e.state.listConnectFinishedCount &&
                                                callFunction(e.callbackQueueList.onListConnectErrorQueue),
                                            setTimeout(function () {
        ...
        checkRetryState() {
            var e = this.options, t = false;
            return ((0 === e.retryMaxCount || this.state.retryCount < e.retryMaxCount) &&
                ((this.state.retryCount += 1), (t = !0)),
                t);
        }
        convertToObject(e) {
            var t = new DataView(e), n = { body: [], packetLen: 0, op: undefined };
            if (((n.packetLen = t.getInt32(CONSTANTS.WS_PACKAGE_OFFSET)),
                this.wsBinaryHeaderList.forEach(function (e) {
                    4 === e.bytes
                ...
                for (var i = CONSTANTS.WS_PACKAGE_OFFSET, r = n.packetLen, u = "", c = ""; i < e.byteLength; i += r) {
                    (r = t.getInt32(i)), (u = t.getInt16(i + CONSTANTS.WS_HEADER_OFFSET));
                    try {
                        if (n.ver === CONSTANTS.WS_BODY_PROTOCOL_VERSION_DEFLATE) {
                            var l = e.slice(i + u, i + r), f = pako.inflate(new Uint8Array(l));
    ...
    exports.DanmakuWebSocket = DanmakuWebSocket;
